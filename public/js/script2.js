...
const modelUrl = "../models/haru/haru_greeter_t03.model3.json";
//const modelUrl = "../models/jin/natori_pro_t06.model3.json";
...
window.mover_cabezaz = (x, z, lerpAmount = 0.7) => {
...
window.mover_cabezay = (x,y,z, lerpAmount = 0.7) => {
...
window.hacer_pose = () => {
    ...
    currentModel.internalModel.motionManager.settings.motions.Idle = [
        {
...
import AudioProcess from './audio/audioWrapper.js';
let audioprocess = new AudioProcess();

window.audioprocess = audioprocess;
//audioprocess.startBufferAnalysis();


let conseguir_vocal = (vocal)=>{
    console.log(vocal);
}


audioprocess.get_vowel(conseguir_vocal);